      ...
      <div align="center">
         ...
         <div class="container">
            ...
            <table border="2">
               <thead>
                  <tr>
                     <th colspan="2" border="0" bgcolor="orange">회원기본정보</th>
                  </tr>
               </thead>
               <tbody class="tbody">
                  <tr>
                  ...
                  <tr>
                     <td>닉네임</td>
                     <td><input type="text" name="mem_nickname" maxlength="8"
                        minlength="2" /> <span>2~8자리의 한글로만 입력</span></td>
                  </tr>
                  <tr>
                     <td>이메일<span class="red">*</span></td>
                     <td><input type="text" name="email_id" />@ <input
                        type="text" name="email_add" id="email_add" /> <select
                        name="email_select" id="email_select" onchange="change_email();">
                  ...
                  <tr>
                     <td>주민등록번호<span class="red">*</span></td>
                     <td><input type="text" name="jumin_num1" size="6"
                        onKeyUp="if(this.value.length == 6) juminForm.jumin_num2.focus();" />-
                        <input type="text" name="jumin_num2" size="7" /> <input
                        type="button" value="주민번호 체크 버튼"
                        onClick="juminCheck(jumin_num1.value, jumin_num2.value)" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td>
                        <!-- [중요] 자바스크립트 적용하여 해결하자!! --> <script>
                           ...
                           document
                                 .write("<select name=mem_Birthday1>")
                           ...
                           document
                                 .write("<select name=mem_Birthday2>")
                           ...
                           document
                                 .write("<select name=mem_Birthday3>")
                  ...
                  <tr>
                     ...
                     <td>
                        <div class="inputArea">
                           <p>
                              <iuput type="text" name="zipCode" id="postcode"
                                 placeholder="우편번호" />
                           ...
                           <p>
                              <input type="text" name="userAddr1" id="address" size="100"
                                 ...
                                 name="userAddr3" id="extraAddress" size="47"
                                 placeholder="참고항목(도로명인 경우:지역 동이름과 아파트 이름)" /> <input
                                 type="text" name="userAddr2" id="detailAddress" size="47"
